...
const Card = ({document}: CardProps) => (
    <div className="md:w-1/3 p-4 box-border">
        <div
            className="relative p-6 bg-white border border-gray-300 rounded-lg transition-shadow duration-300 hover:shadow-md dark:bg-gray-800">
            <div className="flex flex-col mb-2 md:mb-6">
                ...
                <h2 className="text-left font-bold">{document.title}</h2></div>
