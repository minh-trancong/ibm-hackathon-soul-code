...
const Profile = ({ visible }: ProfileProps) => (
    ...
    >
        <div className={`${!visible && "p-2.5 bg-transparent rounded-xl"}`}>
            <div
            ...
            >
                <div className="relative w-10 h-10">
                    ...
                    />
                    <div
                        className="absolute -right-0.75 -bottom-0.75 w-4.5 h-4.5 bg-primary-2 rounded-full border-4 border-n-6"></div>
                </div>
                {!visible && (
                    <>
                        ...
                        <div
                            className="shrnik-0 ml-auto self-start px-3 bg-primary-2 rounded-lg caption1 font-bold text-n-7">
                            Pro
                        </div>
                    </>
                )}
