...
type MessageProps = {
    ...
    image?: string;
    document?: any;
    onButtonClick?: () => void; // New prop for handling button click
};
            ...
            <div className="relative z-2 border-2 border-n-3 rounded-xl overflow-hidden dark:border-n-5">
                ...
                <div className="relative flex items-center min-h-[3.5rem] px-16 text-0">
                    ...
                    <TextareaAutosize
                        ...
                        value={value}
                        onChange={onChange}
                        placeholder={placeholder || "Ask SoulCode anything"}
                    />
                    {value === "" ? (
                        ...
                        <button
                            ...
                            onClick={onButtonClick} // Assign the handler to the onClick event
                        >
